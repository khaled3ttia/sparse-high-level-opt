...
def main(args):
    ...
    for gid in range(1,ngroups+1):
        ...
        sbatch_config['output'] = f'eval4d_group{gid}_stdout.txt'
        sbatch_config['error'] = f'eval4d_group{gid}_stderr.txt'
        sbatch_config['job-name'] = f'eval4d_group{gid}'
        ...
        files.append(f'eval4d_group{gid}.sbatch')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--script', type=str, default='/home/khaled/sparse-high-level-opt/taco_expr/4d/run_tool_4d.sh', help='Bash script path (script to be running within Apptainer on cluster)')
